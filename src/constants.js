...
const ROLE_PAGES = {
  ...
  admin:       ["dashboard","attendance","timetable","notifications","noticeboard","events",
                "classrooms","students","hifz","results","marks","reportcard","dmc","transcript","evaluationscales","evalcenter","welfare","hpri","health","hostel","transport",
                ...
                "exams","seating","analytics","library","madrasa","hifzdashboard","madrasaustad","fees","reports",
                "director","registrar","reportchain","housereportchain","investigationhub","invcase","incidentlog","weaknessmatrix","monthlyplanner","societysystem","leadershiproles","housetemplates","housebazaar","sitaraameen","awardshub","parents","messaging","homeworkhub","aiassistant","aicommand","quizhub","schemeofstudies","academiccalendar","termbreakup","schooldecor","chat","etube","alumni","visitors","meetings","assets","donations","phase2plan","watchlist"],
  teacher:     ["dashboard","timetable","attendance","notifications","noticeboard",
                "marks","hifz","hifzdashboard","results","students","lessons","curriculum","lmaterials","leave","evaluationscales","evalcenter","homeworkhub","aiassistant","aicommand","quizhub","schemeofstudies","academiccalendar","termbreakup","chat","etube"],
  finance:     ["dashboard","fees","salary","slips","donations","reports","aicommand"],
  ...
  housemaster: ["dashboard","students","houses","hvs","evalcenter","superhouse","duties","grandtotal","superannual","investigationhub","invcase","incidentlog","weaknessmatrix","monthlyplanner","societysystem","leadershiproles","housetemplates","housebazaar","sitaraameen","awardshub","tarbiyah","ethics","pride",
                "notifications","attendance","watchlist","housereportchain","aicommand"],
  madrasa:     ["dashboard","madrasa","hifzdashboard","madrasaustad","notifications","students"],
