...
const ROLE_PAGES = {
  ...
  teacher:     ["dashboard","timetable","attendance","notifications","noticeboard",
                "marks","hifz","results","students","lessons","curriculum","lmaterials","leave","evaluationscales","homeworkhub","aiassistant","aicommand","quizhub","schemeofstudies","academiccalendar","termbreakup","chat","etube"],
