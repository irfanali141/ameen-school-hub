...
const ROLE_PAGES = {
  ...
  teacher:     ["dashboard","timetable","attendance","notifications","noticeboard",
                "marks","hifz","results","students","lessons","curriculum","lmaterials","leave","evaluationscales","evalcenter","homeworkhub","aiassistant","aicommand","quizhub","schemeofstudies","academiccalendar","termbreakup","chat","etube"],
  ...
  housemaster: ["dashboard","students","houses","hvs","evalcenter","superhouse","duties","grandtotal","superannual","investigationhub","invcase","incidentlog","weaknessmatrix","monthlyplanner","societysystem","leadershiproles","housetemplates","housebazaar","sitaraameen","tarbiyah","ethics","pride",
