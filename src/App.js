...
// ===================== LOGIN =====================
function AIILogo({size=90}){
  return <svg width={size} height={size} viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
    <circle cx="100" cy="100" r="98" fill="#1e3a6e" stroke="white" strokeWidth="2"/>
    <circle cx="100" cy="100" r="90" fill="none" stroke="#f5a623" strokeWidth="3"/>
    <circle cx="100" cy="100" r="84" fill="none" stroke="#f5a623" strokeWidth="1"/>
    <path d="M 100 20 A 80 80 0 0 1 180 100" fill="none" stroke="none"/>
    <text fontFamily="Arial,sans-serif" fontSize="13" fontWeight="900" fill="white" letterSpacing="2">
      <textPath href="#topArc" startOffset="15%">AMEEN ISLAMIC INSTITUTE</textPath>
    </text>
    <defs>
      <path id="topArc" d="M 22 100 A 78 78 0 0 1 178 100"/>
      <path id="botArc" d="M 178 100 A 78 78 0 0 1 22 100"/>
    </defs>
    <text fontFamily="Arial,sans-serif" fontSize="13" fontWeight="900" fill="white" letterSpacing="2">
      <textPath href="#botArc" startOffset="15%">ESTD. 2025</textPath>
    </text>
    <circle cx="100" cy="100" r="52" fill="#1e3a6e" stroke="white" strokeWidth="2"/>
    <text x="72" y="92" fontFamily="Arial,sans-serif" fontSize="32" fontWeight="900" fill="#f5a623">A</text>
    <text x="108" y="92" fontFamily="Arial,sans-serif" fontSize="32" fontWeight="900" fill="white">I</text>
    <text x="126" y="92" fontFamily="Arial,sans-serif" fontSize="32" fontWeight="900" fill="white">I</text>
    <circle cx="115" cy="110" r="5" fill="#f5a623"/>
  </svg>;
}

function HouseBadge({house,size=130}){
  const configs={
    abuBakr:{color1:"#1e3a8a",color2:"#1d4ed8",name:"ABU BAKR HOUSE",badge:"TRUTH & LOYALTY",
      icon:<><path d="M85 75 L100 65 L115 75 L115 95 L100 105 L85 95 Z" fill="none" stroke="white" strokeWidth="2.5"/><line x1="100" y1="65" x2="100" y2="105" stroke="white" strokeWidth="1.5"/><line x1="85" y1="80" x2="115" y2="80" stroke="white" strokeWidth="1.5"/><path d="M85 80 Q100 70 115 80" fill="none" stroke="white" strokeWidth="2"/><path d="M110 88 Q118 82 126 88 L120 98 Q115 92 110 98 Z" fill="white"/><path d="M74 88 Q82 82 90 88" fill="none" stroke="white" strokeWidth="2.5"/></>
    },
    umar:{color1:"#14532d",color2:"#15803d",name:"UMAR HOUSE",badge:"JUSTICE & DISCIPLINE",
      icon:<><rect x="86" y="78" width="8" height="28" rx="1" fill="white"/><rect x="80" y="104" width="20" height="4" rx="1" fill="white"/><circle cx="90" cy="75" r="5" fill="white" opacity="0.9"/><path d="M108 78 L118 80 L116 90 L108 88 Z" fill="none" stroke="white" strokeWidth="2.5"/><circle cx="116" cy="82" r="10" fill="none" stroke="white" strokeWidth="2"/><line x1="110" y1="76" x2="122" y2="88" stroke="white" strokeWidth="1.5"/><line x1="110" y1="88" x2="122" y2="76" stroke="white" strokeWidth="1.5"/></>
    },
    uthman:{color1:"#713f12",color2:"#a16207",name:"UTHMAN HOUSE",badge:"MODESTY & GENEROSITY",
      icon:<><path d="M88 70 Q82 65 78 72 Q74 80 82 85 Q88 88 92 82 Q98 90 100 85 Q104 78 98 72 Q94 67 88 70Z" fill="white" opacity="0.9"/><path d="M100 88 L110 80 L115 85 L120 78 L126 82" fill="none" stroke="white" strokeWidth="2.5" strokeLinecap="round"/><path d="M108 95 Q116 90 124 95 L122 105 Q116 100 108 105 Z" fill="white" opacity="0.85"/></>
    },
    ali:{color1:"#7f1d1d",color2:"#b91c1c",name:"ALI HOUSE",badge:"BRAVERY & KNOWLEDGE",
      icon:<><path d="M82 108 L90 72 L94 80 L100 68 L106 80 L110 72 L118 108 Z" fill="none" stroke="white" strokeWidth="2.5" strokeLinejoin="round"/><path d="M86 100 L114 100" stroke="white" strokeWidth="2"/><rect x="108" y="78" width="16" height="22" rx="2" fill="none" stroke="white" strokeWidth="2"/><line x1="111" y1="84" x2="121" y2="84" stroke="white" strokeWidth="1.5"/><line x1="111" y1="89" x2="121" y2="89" stroke="white" strokeWidth="1.5"/><line x1="111" y1="94" x2="121" y2="94" stroke="white" strokeWidth="1.5"/></>
    }
  };
  const c=configs[house]; if(!c) return null;
  const r=size/2; const cx=r; const cy=r; const sc=size/200;
  return <svg width={size} height={size} viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
    <defs>
      <linearGradient id={"g"+house} x1="0%" y1="0%" x2="100%" y2="100%">
        <stop offset="0%" stopColor={c.color1}/>
        <stop offset="100%" stopColor={c.color2}/>
      </linearGradient>
      <path id={"ta"+house} d="M 24 100 A 76 76 0 0 1 176 100"/>
      <path id={"ba"+house} d="M 170 116 A 76 76 0 0 1 30 116"/>
    </defs>
    <circle cx="100" cy="100" r="98" fill={`url(#g${house})`}/>
    <circle cx="100" cy="100" r="94" fill="none" stroke="white" strokeWidth="2.5"/>
    <circle cx="100" cy="100" r="88" fill="none" stroke="white" strokeWidth="1"/>
    <text fontFamily="Arial,sans-serif" fontSize="11.5" fontWeight="900" fill="white" letterSpacing="2.5">
      <textPath href={"#ta"+house} startOffset="12%">AMEEN ISLAMIC INSTITUTE</textPath>
    </text>
    <text fontFamily="Arial,sans-serif" fontSize="12" fontWeight="900" fill="white" letterSpacing="2">
      <textPath href={"#ba"+house} startOffset="8%">{c.name}</textPath>
    </text>
    <circle cx="100" cy="100" r="50" fill="none" stroke="white" strokeWidth="2"/>
    <circle cx="100" cy="100" r="46" fill="rgba(0,0,0,0.15)"/>
    <g>{c.icon}</g>
    <rect x="68" y="111" width="64" height="14" rx="3" fill="rgba(255,255,255,0.95)"/>
    <text x="100" y="121.5" fontFamily="Arial,sans-serif" fontSize="7.5" fontWeight="900" fill={c.color1} textAnchor="middle" letterSpacing="0.5">{c.badge}</text>
  </svg>;
}
...
function Login({onLogin,err,loading}){
  ...
  if(showLogin) return <div style={S.lp}>
    ...
    <div style={S.lc}>
      ...
      <div style={{textAlign:"center",marginBottom:"28px"}}>
        <div style={{margin:"0 auto 16px",display:"flex",justifyContent:"center"}}><AIILogo size={70}/></div>
  ...
  return <div style={{minHeight:"100vh",background:"linear-gradient(180deg,#0f172a 0%,#1e293b 60%,#0f172a 100%)",overflowY:"auto",position:"relative"}}>
    ...
    <div style={{position:"relative",zIndex:1,maxWidth:"860px",margin:"0 auto",padding:"0 16px 60px"}}>

      {/* HEADER — AII Logo SVG */}
      <div style={{textAlign:"center",padding:"40px 20px 28px"}}>
        <div style={{display:"flex",justifyContent:"center",marginBottom:"18px",filter:"drop-shadow(0 0 20px rgba(245,166,35,0.3))"}}>
          <AIILogo size={110}/>
        </div>
        <div style={{fontFamily:"'Amiri',serif",fontSize:"1.9rem",fontWeight:"700",color:"#e8b84b",marginBottom:"6px",textShadow:"0 2px 20px rgba(183,134,11,0.3)"}}>امین اسلامک انسٹیٹیوٹ</div>
        ...
        <div style={{fontSize:"0.78rem",color:"rgba(255,255,255,0.55)",fontFamily:"'Amiri',serif"}}>ہاؤس سسٹم — سیشن 2026-27</div>
      </div>

      {/* HOUSE BADGES SVG */}
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"20px",marginBottom:"28px",padding:"0 8px"}}>
        {["abuBakr","umar","uthman","ali"].map(h=><div key={h} style={{display:"flex",justifyContent:"center",filter:"drop-shadow(0 6px 20px rgba(0,0,0,0.4))"}}>
          <HouseBadge house={h} size={150}/>
        </div>)}
      </div>

      {/* THEME BANNER */}
      <div style={{borderRadius:"18px",background:"linear-gradient(135deg,rgba(183,134,11,0.12),rgba(183,134,11,0.04))",border:"2px solid rgba(183,134,11,0.25)",padding:"18px",textAlign:"center",marginBottom:"20px"}}>
        ...
        <div style={{fontSize:"0.82rem",fontFamily:"'Amiri',serif",color:"rgba(255,255,255,0.55)",marginTop:"5px"}}>ایمان • نظم • برتری</div>
      </div>
      ...
      <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:"10px",marginBottom:"28px"}}>
        {[{n:"4",l:"Houses",u:"ہاؤس"},{n:"160",l:"HVS Points",u:"زیادہ سے زیادہ"},{n:"2026",l:"Session",u:"تعلیمی سال"}].map((s,i)=><div key={i} style={{borderRadius:"14px",background:"rgba(255,255,255,0.04)",border:"1px solid rgba(255,255,255,0.08)",padding:"14px",textAlign:"center"}}>
          ...
          <div style={{fontSize:"0.52rem",color:"rgba(255,255,255,0.45)",fontFamily:"'Cinzel',serif",letterSpacing:"0.08em",marginTop:"2px"}}>{s.l}</div>
          <div style={{fontSize:"0.52rem",color:"rgba(183,134,11,0.6)",marginTop:"1px"}}>{s.u}</div>
        </div>)}
      </div>

      {/* LOGIN BUTTON */}
      <button onClick={()=>setShowLogin(true)} style={{width:"100%",padding:"16px",borderRadius:"16px",border:"none",background:"linear-gradient(135deg,#b7860b,#7a5807)",color:"white",fontSize:"0.88rem",fontWeight:"700",cursor:"pointer",fontFamily:"'Amiri',serif",boxShadow:"0 8px 30px rgba(183,134,11,0.4)",letterSpacing:"0.05em"}}>
        🔐 اسکول ہب میں داخل ہوں
      </button>
      <div style={{textAlign:"center",marginTop:"12px",fontSize:"0.55rem",color:"rgba(255,255,255,0.25)",fontFamily:"'Cinzel',serif",letterSpacing:"0.1em"}}>AMEEN SCHOOL HUB • STAFF & MANAGEMENT PORTAL</div>
    </div>
  </div>;
}
...
function LessonPlans({teachers,addData}){
  ...
  return <div style={S.page}>
    ...
    <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(300px,1fr))",gap:"14px"}}>
      {plans.map(p=>{ const t=teachers.find(x=>x.id===p.teacherId); return <div key={p.id} style={{...S.card,borderTop:`4px solid ${C.abuBakr}`}}>
      ...
      {plans.length===0&&<div style={{...S.card,textAlign:"center",color:"#bbb",padding:"40px",gridColumn:"1/-1"}}><div style={{fontSize:"3rem",marginBottom:"12px"}}>📅</div>کوئی منصوبہ نہیں</div>}
    </div>
  </div>;
}
...
function ClassAnalytics({students,results}){
  ...
  return <div style={S.page}>
    ...
    <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"20px",marginBottom:"20px"}}>
      <div style={S.card}><div style={{fontSize:"0.85rem",fontWeight:"700",color:C.navy,marginBottom:"16px"}}>🏠 ہاؤس کارکردگی</div>
      ...
      <div style={S.card}><div style={{fontSize:"0.85rem",fontWeight:"700",color:C.navy,marginBottom:"16px"}}>🏆 ٹاپ طلبا</div>
    ...
    <div style={S.card}><div style={{fontSize:"0.85rem",fontWeight:"700",color:C.navy,marginBottom:"16px"}}>📚 مضمون وار تجزیہ</div>
...
function TranscriptRequest({students,addData}){
  ...
  return <div style={S.page}>
    ...
    <div style={{display:"flex",flexDirection:"column",gap:"12px"}}>
      {requests.map(r=>{ const p=purposes[r.purpose]||purposes.personal; const u=urgencies[r.urgency]||urgencies.normal; const st=students.find(s=>s.id===r.studentId); return <div key={r.id} style={{...S.card,borderRight:`4px solid ${p.c}`}}>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:"8px"}}>
      ...
      {requests.length===0&&<div style={{...S.card,textAlign:"center",color:"#bbb",padding:"60px"}}>کوئی درخواست نہیں</div>}
    </div>
  </div>;
}
...
function TeacherLeave({teachers,addData}){
  ...
  return <div style={S.page}>
    ...
    {pending.length>0&&<div style={{...S.card,marginBottom:"20px",background:"linear-gradient(135deg,#fef3c7,#fff)",border:`2px solid ${C.amber}20`}}>
    ...
    <div style={S.card}><div style={{overflowX:"auto"}}><table style={{width:"100%",borderCollapse:"collapse"}}>
      <thead><tr><th style={S.th}>استاد</th><th style={S.th}>قسم</th><th style={S.th}>تاریخ</th><th style={S.th}>حال</th></tr></thead>
  ...
  if(selSlip){ const t=teachers.find(x=>x.id===selSlip.teacherId)||{}; return <div style={S.page}>
    ...
    <div style={{background:C.white,borderRadius:"22px",overflow:"hidden",boxShadow:"0 8px 32px rgba(0,0,0,0.12)",maxWidth:"600px",margin:"0 auto"}}>
      <div style={{background:`linear-gradient(135deg,${C.navyDark},${C.navyMid})`,padding:"24px",color:C.white,textAlign:"center"}}>
        ...
        <div style={{fontSize:"0.65rem",opacity:0.7,marginBottom:"12px"}}>AMEEN ISLAMIC INSTITUTE • SWAT</div>
        <div style={{background:"rgba(255,255,255,0.1)",borderRadius:"10px",padding:"10px"}}><div style={{fontSize:"0.82rem",fontWeight:"700",color:C.gold}}>تنخواہ سلپ — {selSlip.month} {selSlip.year}</div></div>
      </div>
      <div style={{padding:"20px 24px"}}>
        <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"10px",marginBottom:"20px",background:"#fafaf8",borderRadius:"12px",padding:"14px"}}>
          {[["نام",t.name||"—"],["عہدہ",t.subject||"استاد"],["مہینہ",`${selSlip.month} ${selSlip.year}`]].map(([l,v])=><div key={l}><div style={{fontSize:"0.58rem",color:"#888"}}>{l}</div><div style={{fontSize:"0.72rem",fontWeight:"700",color:C.navy}}>{v}</div></div>)}
        </div>
        {[["آمدنی",[[" بنیادی",selSlip.basicSalary],["مکان کرایہ",selSlip.houseRent],["طبی",selSlip.medicalAllowance],["ٹرانسپورٹ",selSlip.transport],["بونس",selSlip.bonus]],C.green,"مجموعی آمدنی",selSlip.gross],["کٹوتیاں",[["کٹوتیاں",selSlip.deductions],["ٹیکس",selSlip.tax]],C.red,"مجموعی کٹوتی",Number(selSlip.deductions)+Number(selSlip.tax)]].map(([title,items,color,totalLabel,total])=><div key={title} style={{marginBottom:"20px"}}>
          <div style={{fontSize:"0.75rem",fontWeight:"700",color,marginBottom:"10px",borderBottom:`1px solid ${color}30`,paddingBottom:"6px"}}>{title}</div>
          {items.filter(([,v])=>v>0).map(([l,v])=><div key={l} style={{display:"flex",justifyContent:"space-between",marginBottom:"6px",fontSize:"0.68rem"}}><span style={{color:"#555"}}>{l}</span><span style={{fontWeight:"600",color:C.navy}}>Rs. {Number(v).toLocaleString()}</span></div>)}
          <div style={{display:"flex",justifyContent:"space-between",marginTop:"8px",paddingTop:"6px",borderTop:`2px solid ${color}30`,fontSize:"0.72rem",fontWeight:"800",color}}><span>{totalLabel}</span><span>Rs. {Number(total).toLocaleString()}</span></div>
        </div>)}
        <div style={{background:`linear-gradient(135deg,${C.gold},${C.goldDark})`,borderRadius:"14px",padding:"16px",textAlign:"center"}}><div style={{fontSize:"0.65rem",color:"rgba(255,255,255,0.8)",marginBottom:"4px"}}>خالص تنخواہ</div><div style={{fontSize:"2rem",fontWeight:"900",color:C.white}}>Rs. {Number(selSlip.net).toLocaleString()}</div></div>
      </div>
    </div>
  </div>; }
  return <div style={S.page}>
    <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"16px"}}>
      <div><div style={{fontSize:"1.1rem",fontWeight:"700",color:C.navy}}>💳 تنخواہ سلپ</div><div style={{fontSize:"0.62rem",color:"#888",marginTop:"2px"}}>ماہانہ تنخواہ کا ریکارڈ</div></div>
      <button style={S.addBtn} onClick={()=>setShow(!show)}>+ نئی سلپ</button>
    </div>
    {show&&<div style={{...S.card,marginBottom:"20px",background:`linear-gradient(135deg,${C.goldLight},#fdf8ee)`,border:`2px solid ${C.gold}30`}}>
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"12px",marginBottom:"12px"}}>
        <div><label style={{fontSize:"0.62rem",color:"#888",marginBottom:"4px",display:"block"}}>استاد *</label><select style={S.inpSm} value={f.teacherId} onChange={e=>setF({...f,teacherId:e.target.value})}><option value="">-- منتخب کریں --</option>{teachers.map(t=><option key={t.id} value={t.id}>{t.name}</option>)}</select></div>
        <div><label style={{fontSize:"0.62rem",color:"#888",marginBottom:"4px",display:"block"}}>مہینہ *</label><select style={S.inpSm} value={f.month} onChange={e=>setF({...f,month:e.target.value})}><option value="">-- منتخب کریں --</option>{months.map(m=><option key={m}>{m}</option>)}</select></div>
        {[["بنیادی","basicSalary"],["مکان","houseRent"],["طبی","medicalAllowance"],["ٹرانسپورٹ","transport"],["بونس","bonus"],["کٹوتیاں","deductions"],["ٹیکس","tax"]].map(([l,k])=><div key={k}><label style={{fontSize:"0.62rem",color:"#888",marginBottom:"4px",display:"block"}}>{l} (Rs)</label><input style={{...S.inpSm,direction:"ltr"}} type="number" value={f[k]} onChange={e=>setF({...f,[k]:e.target.value})}/></div>)}
      </div>
      <div style={{background:C.white,borderRadius:"10px",padding:"12px",marginBottom:"12px",textAlign:"center"}}><div style={{fontSize:"0.62rem",color:"#888"}}>خالص تنخواہ</div><div style={{fontSize:"1.5rem",fontWeight:"900",color:C.gold}}>Rs. {(Number(f.basicSalary)+Number(f.houseRent)+Number(f.medicalAllowance)+Number(f.transport)+Number(f.bonus)-Number(f.deductions)-Number(f.tax)).toLocaleString()}</div></div>
      <button style={S.saveBtn} onClick={add}>✅ سلپ بنائیں</button>
    </div>}
    <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(280px,1fr))",gap:"14px"}}>
      {slips.map(sl=>{ const t=teachers.find(x=>x.id===sl.teacherId); return <div key={sl.id} style={{...S.card,cursor:"pointer",borderTop:`4px solid ${C.gold}`}} onClick={()=>setSelSlip(sl)}><div style={{display:"flex",justifyContent:"space-between",marginBottom:"8px"}}><div><div style={{fontSize:"0.85rem",fontWeight:"700",color:C.navy}}>{t?.name||"—"}</div><div style={{fontSize:"0.62rem",color:"#888"}}>{sl.month} {sl.year}</div></div><span style={hBadge(C.gold,C.goldLight)}>💳</span></div><div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}><span style={{fontSize:"0.62rem",color:"#888"}}>خالص</span><span style={{fontSize:"1rem",fontWeight:"800",color:C.gold}}>Rs. {Number(sl.net).toLocaleString()}</span></div><div style={{fontSize:"0.6rem",color:C.abuBakr,marginTop:"8px"}}>👁️ سلپ دیکھیں ←</div></div>; })}
      {slips.length===0&&<div style={{...S.card,textAlign:"center",color:"#bbb",padding:"40px",gridColumn:"1/-1"}}>کوئی سلپ نہیں</div>}
    </div>
  </div>;
}
...
function LearningMaterials({teachers,addData}){
  ...
  return <div style={S.page}>
    ...
    <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(260px,1fr))",gap:"14px"}}>
      {filtered.map(m=>{ const tc=types[m.type]||types.link; const t=teachers.find(x=>x.id===m.teacherId); return <div key={m.id} style={{...S.card,borderTop:`4px solid ${tc.c}`}}>
      ...
      {filtered.length===0&&<div style={{...S.card,textAlign:"center",color:"#bbb",padding:"40px",gridColumn:"1/-1"}}>کوئی مواد نہیں</div>}
    </div>
  </div>;
}
...
export default function App(){
  ...
  const PAGES=[
    ...
    {id:"transcript",label:"📜 ٹرانسکرپٹ"},{id:"leave",label:"🏖️ چھٹی"},
    {id:"slips",label:"💳 تنخواہ سلپ"},{id:"lmaterials",label:"📚 تعلیمی مواد"},
  ];
